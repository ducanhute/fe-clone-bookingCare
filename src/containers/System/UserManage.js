    ...
    render() {
        ...
        return (
            <div className="user-container">
                ...
                <button className="btn btn-primary px-2 mx-2" onClick={() => this.handleAddNewUser()}>
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td className="action-col">
                                            <button className="edit-btn" onClick={() => this.handleEditUser(arrUser)}>
                                                <i className=" fas fa-pencil-alt"></i> Edit
                                            </button>
                                            <button className="delete-btn" onClick={() => this.handleDeleteUser(arrUser.id)}>
